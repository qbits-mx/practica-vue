<template>
    <div class="col d-md-flex align-items-center">
        ...
        <div class="carousel-inner mb-5 shadow-1-strong rounded-3">
            ...
            <img :src=baseUrl+elemento class="d-block w-100" alt="..." />
            </div>
        </div>
        <!-- Slides -->
        ...
        <div class="carousel-indicators" style="margin-bottom: -20px;">
            <span v-for="(miniatura,index) in img" v-bind:key="index" class="ajusta">
            ...
            <img :src=baseUrl+img[index] class="d-block w-100 shadow-1-strong rounded img-fluid"/>
            </button>
            </span>
        </div>
        <!-- Thumbnails -->
